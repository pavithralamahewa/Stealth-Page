        ...
        <div className="container-grid">
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-16 mb-20">
            ...
            <ScrollReveal delay={0.1} className="lg:col-span-7 flex flex-col justify-center">
              <p className="text-[15px] font-serif italic text-muted-foreground/80 mb-6">
              ...
              <p className="text-[15px] font-serif italic text-muted-foreground/80">
                "That's the shift—from AI in learning, to learning that actually works."
              </p>
            </ScrollReveal>
          </div>

          <ScrollReveal>
            <p className="text-[clamp(1.5rem,3vw,2.2rem)] leading-[1.25] font-serif italic text-foreground tracking-[-0.01em] mb-12 max-w-2xl">
